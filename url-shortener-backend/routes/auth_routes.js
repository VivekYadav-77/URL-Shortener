...
auth_router.post("/login", authLimiter,validate(loginSchema),blockGuard, login);
...
auth_router.post("/resend-verification", authLimiter,blockGuard, resendVerification);
