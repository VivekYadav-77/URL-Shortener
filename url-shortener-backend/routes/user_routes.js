...
import { updateProfilenname,updateProfilepassword } from "../config/auth_validator.js"
...
user_routers.patch("/me",authMiddleware,criticalActionGuard,validate(updateProfilenname),updateMe)
user_routers.patch("/me/password",authMiddleware,criticalActionGuard,validate(updateProfilepassword),changePassword)
