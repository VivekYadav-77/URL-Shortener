...
const AboutUs = () => {
  ...
  const navigate = useNavigate(); // Hook to handle "go back"
  ...
  return (
    <section className={`min-h-screen py-20 px-6 relative overflow-hidden transition-colors duration-700 ${
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          ...
          >
            Inside <span className="text-blue-600">Shorten Life.</span>
          </motion.h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-[4rem] opacity-20 blur-2xl group-hover:opacity-40 transition-opacity duration-500" />
            
            <div className={`relative aspect-square rounded-[3.5rem] border-2 overflow-hidden flex items-center justify-center ${
              ...
              <div className="flex flex-col items-center gap-4 text-slate-500">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">Awaiting Identity Upload</span>
              </div>
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 backdrop-blur-md bg-white/5 border border-white/10 rounded-2xl">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-[10px] font-bold text-blue-500 uppercase">System Architect</p>
                    <p className="text-sm font-black uppercase">Your Name Here</p>
                  </div>
          ...
          <div className="space-y-8">
            <motion.div 
              ...
              className="space-y-4"
            >
              <h3 className="text-2xl font-black tracking-tight uppercase">Re-Engineering Digital Shortcuts</h3>
              <p className={`text-lg leading-relaxed ${isDark ? "text-slate-400" : "text-slate-600"}`}>
                Shorten Life isn't just a URL utility. It's a high-performance identity portal designed to compress the distance 
                between data and discovery. We believe that security shouldn't be a hurdle, but a foundation.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {stats.map((stat, index) => (
                ...
                >
                  ...
                  <div className="text-[9px] font-black uppercase tracking-tighter opacity-50">{stat.label}</div>
            ...
            >
              ...
              <div>
                <p className="text-[10px] font-black uppercase tracking-widest text-blue-500">Developed By</p>
                <p className="text-sm font-bold opacity-80 font-mono">anujyadav@root:~$</p>
              </div>
            </motion.div>
          </div>
        </div>
