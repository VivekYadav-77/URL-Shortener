...
export const UserSidebar = ({ onNavigate, isMobile }) => {
  ...
  const navItems = [
    ...
    { to: "/contactus", label: "Contactus", icon: <Mail size={20} /> },
  ];
    ...
    >
      ...
      <div className="flex justify-between items-center w-full mb-10 px-2">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 bg-linear-to-br from-blue-600 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/30 rotate-3">
            <Link2 size={20} className="text-white" />
          </div>
          <div className="flex flex-col">
            <span
              className={`text-xl font-black tracking-tighter leading-none ${isDark ? "text-white" : "text-gray-900"}`}
            >
      ...
      <div className="mt-auto">
        <div
          className={`p-5 rounded-4xl border transition-all hover:scale-[1.02] ${
        ...
        >
          <div className="flex items-center gap-2 mb-2">
            ...
            <p
              className={`text-[10px] font-black uppercase tracking-widest ${isDark ? "text-gray-500" : "text-blue-500"}`}
            >
              Power User
            </p>
          </div>
          <p
            className={`text-xs font-bold leading-relaxed ${isDark ? "text-gray-400" : "text-blue-900"}`}
          >
