  ...
  return (
    <div className={`
      ...
      <div className="absolute bottom-8 left-6 right-6">
        <div className={`p-4 rounded-2xl border ${isDark ? "bg-white/5 border-white/10" : "bg-blue-50 border-blue-100"}`}>
          <p className={`text-[10px] font-bold uppercase mb-1 ${isDark ? "text-gray-500" : "text-blue-400"}`}>System Status</p>
          <div className="flex items-center gap-2">
            <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse" />
            <span className={`text-xs font-black ${isDark ? "text-gray-300" : "text-blue-900"}`}>All Systems Operational</span>
          </div>
        </div>
      </div>
    </div>
