...
const CreateUrl = () => {
  ...
  return (
    <UserLayout>
      <div className={`min-h-screen py-12 px-4 transition-colors duration-500 ${isDark ? "bg-[#050505]" : "bg-gray-50"}`}>
        <main className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className={`text-5xl font-black tracking-tight mb-4 ${isDark ? "text-white" : "text-gray-900"}`}>
              Create <span className="bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">Short Link</span>
            </h2>
            <p className={`text-lg ${isDark ? "text-gray-400" : "text-gray-500"}`}>
              Optimize your destination with custom aliases and expiration tracking.
            </p>
          </div>
          ...
          <form
            ...
            className={`relative overflow-hidden rounded-[2.5rem] border shadow-2xl p-8 md:p-10 transition-all ${
              isDark ? "bg-white/5 border-white/10 shadow-black" : "bg-white border-gray-200"
            }`}
          >
            <div className="space-y-8 relative z-10">
              ...
              <div className="space-y-2">
                <label className={`flex items-center gap-2 text-sm font-black uppercase tracking-wider ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                  <LinkIcon size={16} className="text-blue-500" /> Destination URL
                </label>
                <input
                  type="url"
                  required
              ...
              <div className={`p-6 rounded-3xl border transition-all ${
                ...
                <div className="flex items-center justify-between mb-3">
                  <p className={`text-[10px] font-black uppercase tracking-widest ${isDark ? "text-blue-400/60" : "text-blue-500"}`}>
              ...
              <div className="space-y-2">
                <label className={`flex items-center gap-2 text-sm font-black uppercase tracking-wider ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                  <Calendar size={16} className="text-pink-500" /> Link Expiration
                </label>
                <input
                  type="date"
                ...
                <div className="flex justify-between items-center px-1">
                  <p className={`text-[10px] font-bold ${isDark ? "text-gray-600" : "text-gray-400"}`}>
              ...
              {isError && (
                <div className="p-4 rounded-2xl bg-red-500/10 border border-red-500/20 flex items-center gap-3 text-red-500">
                  <AlertCircle size={18} />
                  <p className="text-sm font-bold">{error?.data?.message || "Internal Service Error"}</p>
                </div>
              )}
