...
const ResetPassword = () => {
  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center px-4 overflow-hidden relative transition-colors duration-700 ${
    ...
    >
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p
            className={`text-[10px] font-black uppercase tracking-[0.3em] mt-2 ${isDark ? "text-slate-500" : "text-slate-400"}`}
          >
          ...
          {isSuccess ? (
            <motion.div
              ...
              className={`p-10 rounded-[3rem] border text-center space-y-6 ${
                isDark
                  ? "bg-white/2 border-white/10 shadow-black"
            ...
            >
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-black uppercase tracking-widest text-blue-500 flex justify-between px-1">
                  ...
                  <span
                    className={`${password.length >= 8 ? "text-green-500" : "text-gray-500"}`}
                  >
                    {password.length}/8
                  </span>
                </label>
              ...
              <AnimatePresence>
                {(localError || isError) && (
                  ...
                  >
                    <AlertCircle size={14} />{" "}
                    {localError || error?.data?.message || "Synthesis Failed"}
                  </motion.div>
                )}
              </AnimatePresence>
