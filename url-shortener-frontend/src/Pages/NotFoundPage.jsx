...
const SpaceNotFound = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#05060f] overflow-hidden flex flex-col items-center justify-center text-white font-sans">
      ...
      >
        {/* Curvy Cord/Trail */}
        <svg width="250" height="150" viewBox="0 0 250 150" className="absolute right-10 top-5 -z-10 overflow-visible">
          <motion.path
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="flex items-center justify-center relative">
          {/* Big "4" */}
          <h1 className="text-[18rem] font-bold text-[#1f232b] leading-none select-none">4</h1>
          
          {/* Central Red Planet and Sitting Astronaut */}
          <div className="relative w-64 h-64 mx-[-20px] z-10">
             {/* The Red Planet */}
             ...
             >
                <svg viewBox="0 0 100 120" fill="none">
                  {/* Suit */}
                  <rect x="30" y="30" width="40" height="50" rx="15" fill="#e2e8f0" />
                  {/* Helmet */}
                  <rect x="25" y="5" width="50" height="45" rx="20" fill="#e2e8f0" stroke="#1f232b" strokeWidth="2" />
                  <rect x="32" y="12" width="36" height="25" rx="10" fill="#1a1c2c" />
                  {/* Sitting Legs */}
                  <path d="M 35 80 L 25 105 L 40 105" fill="#e2e8f0" stroke="#1f232b" />
                  <path d="M 65 80 L 75 105 L 60 105" fill="#e2e8f0" stroke="#1f232b" />
                  {/* Arms */}
                  <path d="M 30 50 L 10 40" stroke="#e2e8f0" strokeWidth="8" strokeLinecap="round" />
                  <path d="M 70 50 L 90 40" stroke="#e2e8f0" strokeWidth="8" strokeLinecap="round" />
                </svg>
             </motion.div>
          </div>
        ...
        <div className="mt-[-20px] text-center z-20">
          ...
          <p className="text-gray-400 tracking-[0.3em] font-light text-xl">PAGE NOT FOUND</p>
        </div>
