      ...
      <div className="max-w-[1600px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col">
            <span className={`text-2xl font-black tracking-tighter leading-none ${isDark ? "text-white" : "text-gray-900"}`}>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <div className="hidden sm:flex flex-col text-left">
              <span className={`text-xs font-black truncate max-w-[100px] ${isDark ? "text-gray-200" : "text-gray-900"}`}>
                {user?.name || "User"}
              </span>
